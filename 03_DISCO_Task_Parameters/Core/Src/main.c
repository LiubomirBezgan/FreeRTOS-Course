...
const uint16_t * blue_led = (uint16_t *) LED_Blue_Pin;
const uint16_t * red_led = (uint16_t *) LED_Red_Pin;
const uint16_t * green_led = (uint16_t *) LED_Green_Pin;
const uint16_t * orange_led = (uint16_t *) LED_Orange_Pin;
/* USER CODE END PV */
